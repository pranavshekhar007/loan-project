...
const page = () => {
  ...
  const loanApplicationList = async () => {
    setLoading(true);
    try {
      const res = await AppliedLoanListServ({ userId: loggedUserData?._id  , status:"rejected"});
          ...
          <div className="profile-container">
            <div className="profile-header">
              <div className="profile-info">
                <h1 className="h3-big fw-bold">Rejected Loan Applications</h1>
                      ...
                      {loading ? (
                        ...
                        loans.map((loan) => (
                          <tr key={loan._id} onClick={() => handleDtailClick(loan)} >
                            ...
                            <td
                              className="loan-status status-rejected"
                            >
