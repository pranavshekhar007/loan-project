                ...
                <div className="col-lg-4 col-md-6">
                  <div className="mega-item">
                    ...
                    <div className="row">
                      ...
                      <div className="col-10">
                        <h3 className="text-dark"> Loan Against Property</h3>
        ...
        <li className="nav-item">
          ...
          <div className="collapse" id="loanMenu">
            <ul className="list-unstyled offcanvas-list ps-3">
              <li><a href="/personal-loan"><span><i className="bi bi-cash-coin"></i></span> Personal Loan</a></li>
              <li><a href="/business-loan"> <span><i className="bi bi-briefcase"></i></span> Business Loan</a></li>
              ...
              <li><a href="/loan-against-property"> <span> <i className="bi bi-building"></i></span> Loan Against Property</a></li>
            </ul>
          </div>
        </li>
