        ...
        >
          ...
          <div className="form-container sign-up-container">
            <form onSubmit={handleSignUpSubmit}>
                   ...
                   value={signUpFormData.phone}
                    ...
                    <CountryPhoneInput
                      value={{
                        ...
                        countryCode: signUpFormData.countryCode,
                      }}
                      onChange={(val) =>
                        setSignUpFormData((prev) => ({
                          ...prev,
              ...
              <button type="submit">
                {loadingSignUp ? <FaSpinner className="spin" /> : "Sign Up"}
              </button>
          ...
          <div className="form-container sign-in-container">
            <form onSubmit={handleLoginOtpSubmit}>
              ...
              <button type="submit" className="otp" onClick={handleSendOtp}>
                {loadingSendOtp ? <FaSpinner className="spin" /> : "Send OTP"}
              </button></>
                )
              }
...
<div className="form-group">
  ...
  />
                 ...
                 <button
      type="button"
      className="" style={{width:"fit-content"}}
    ...
    >
      Change Number
                  ...
                  <button type="submit">
                    {loadingSignIn ? <FaSpinner className="spin" /> : "Sign In"}
                  </button>
          ...
          <div className="overlay-container">
            <div className="overlay">
              ...
              <div className="overlay-panel overlay-left">
                ...
                <h1>Welcome Back to Rupee Loan!</h1>
                <p>
                  Log in to check your active loans, EMI schedules and offers.
                </p>
                <button
                  className="ghost signin-change-btn"
                  onClick={() => setIsRightPanelActive(false)}
                >
                  Sign In
                </button>
              ...
              <div className="overlay-panel overlay-right">
                ...
                <h1>Need Quick Cash?</h1>
                <p>
                  Sign up with Rupee Loan to apply for instant loans and track
                  repayments.
                </p>
                <button
                  className="ghost signup-change-btn"
                  onClick={() => setIsRightPanelActive(true)}
                >
                  Sign Up
                </button>
